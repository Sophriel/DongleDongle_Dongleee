   ...
   void Start()
    {
        ...
        //  음악 파일 로드
        file = new FileInfo("Assets/Music/Music" + UnityEngine.SceneManagement.SceneManager.GetActiveScene().buildIndex.ToString() + ".txt");
        ...
        beats = new int[values.Length];  //  비트 저장

        for (int i = 0; i < values.Length; i++)
            beats[i] = System.Convert.ToInt32(values[i]);
    }
